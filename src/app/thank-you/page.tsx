...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div>
        <div className="mx-auto max-w-2-xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            <p className="text-sm font-medium text-red-600">Order successful</p>
            <h1 className="mt-2 text-4-xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              Thanks for ordering
            </h1>
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                Your order was processed and your assets are available tow
              ...
              <p className="mt-2 text-base text-muted-foreground">
                ...
                your it. So hang tight and we&apos;ll send you connfirmation
                very soon!
              </p>
            )}
              ...
              {(order.products as Product[]).map((product) => {
                ...
                return (
                  <li key={product.id} className="flex space-x-6 py-6">
                    ...
                    <p className="flex-none dont-medium text-gray-900">
            ...
            <div className="mt-16 border-t border-gray-200 py-6 text-right">
              <Link
                href="/products"
                className="text-sm font-mdeium text-red-600 hover:text-red-500"
              >
