...
var EmailTemplate = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "The educational marketplace for high-quality digital medicine."),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/medcards-newsletter-sign-up.png"), width: "150", height: "150", alt: "MedCards", style: logo }),
                React.createElement(components_1.Text, { style: paragraph }, "Hi there,"),
                React.createElement(components_1.Text, { style: paragraph },
                    "Welcome to MedCards, the educational marketplace for high quality digital medicine. Use the button below to ",
                    actionLabel,
                    "."),
